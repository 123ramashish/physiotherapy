...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://skmphysiotherapy.com/OurPartners-skm-physiotherapy",
    siteName: "SKM Physiotherapy & Rehabilitation Centre",
    images: [
      {
        url: "https://skmphysiotherapy.com/og-partners.jpg",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: ["https://skmphysiotherapy.com/og-partners.jpg"],
    creator: "@skmphysio",
  },

  alternates: {
    canonical: "https://skmphysiotherapy.com/OurPartners-skm-physiotherapy",
    languages: { "en-IN": "https://skmphysiotherapy.com/OurPartners-skm-physiotherapy" },
  },
...
const breadcrumbData = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "Our Partners", item: "https://skmphysiotherapy.com/OurPartners-skm-physiotherapy" },
  ],
};
