...
// ── Static Data ───────────────────────────────────────────────
const ACC = '#10b981'; // Emerald/Teal for Sector 135
const ACC_LIGHT = '#ecfdf5';
const ACC_MID = '#059669';
const RGB = '16,185,129';

const BRANCH = {
  name: 'SKM Physiotherapy — Noida Sector 135',
  location: 'Sector 135, Noida',
  tagline: 'Premium physiotherapy care serving Noida Expressway',
  address: 'B-45, Sector 135',
  city: 'Noida, Uttar Pradesh — 201303',
  phone: '9876543210',
  whatsapp: '919876543210',
  email: 'noida135@skmphysio.in',
  established: '2022',
  timings: { weekdays: '8:00 AM – 8:00 PM', saturday: '9:00 AM – 6:00 PM', sunday: 'Closed' },
  landmarks: ['Near Jaypee Wish Town', 'Sector 135 B-Block', 'Easy access from Expressway'],
  mapEmbed: 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3507.3574263498254!2d77.3441583!3d28.5194919!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390ce60b64d00001%3A0x6790938f328f8f8!2sSector%20135%2C%20Noida%2C%20Uttar%20Pradesh!5e0!3m2!1sen!2sin!4v1620000000000',
  mapLink: 'https://maps.google.com/?q=Sector+135+Noida',
  stats: [{ n: '12+', l: 'Services' }, { n: '2', l: 'Doctors' }, { n: '2022', l: 'Est.' }, { n: '4.8★', l: 'Rating' }, { n: '300+', l: 'Patients' }],
  services: [
    'Dry Needling', 'Back Pain Treatment', 'Neck Pain Therapy',
  ...
  doctors: [
    {
      ...
      specializations: ['Orthopaedic Physiotherapy', 'Sports Rehabilitation'],
    ...
    },
    {
      ...
      specializations: ['Sports Taping', 'Injury Prevention', 'Gym Rehab'],
      photo: 'https://images.unsplash.com/photo-1622253692010-333f2da6031d?w=500&q=80',
      regNo: 'UP-PT-2020-0891',
      languages: ['Hindi', 'English'],
    },
  ],
  clinicPhotos: [
    { url: 'https://images.unsplash.com/photo-1519494026892-80bbd2d6fd0d?w=800&q=80', caption: 'Clinic Entrance' },
    { url: 'https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?w=800&q=80', caption: 'Treatment Zone' },
  ],
  amenities: ['Ample Parking', 'Modern Equipment', 'Home Visit Service', 'Clean Environment', 'Professional Staff'],
  payment: ['Cash', 'UPI', 'Paytm'],
  faqs: [
    { q: 'Where is the Sector 135 branch?', a: 'B-45, Sector 135, Noida. Landmarks: Near Jaypee Wish Town, easily accessible from the Noida Expressway.' },
    { q: 'What are the branch timings?', a: 'Weekdays: 8:00 AM – 8:00 PM | Saturday: 9:00 AM – 6:00 PM | Sunday: Closed.' },
...
// ── Page Component ────────────────────────────────────────────
export default function Sector135Page() {
      ...
      <div className="bp1">
          ...
          <div style={{ maxWidth: 1200, margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(300px,1fr))', gap: '3rem', alignItems: 'center', position: 'relative', zIndex: 1 }}>
            <div>
              <div style={{ display: 'inline-flex', alignItems: 'center', gap: 8, background: ACC_LIGHT, border: `1px solid ${ACC}44`, borderRadius: 50, padding: '6px 16px', marginBottom: '1.25rem' }}>
                <Building2 size={14} color={ACC} /><span style={{ fontSize: '0.72rem', fontWeight: 700, color: ACC, textTransform: 'uppercase', letterSpacing: '0.07em' }}>Noida · Est. {BRANCH.established}</span>
              </div>
              <h1 className="bp1-display" style={{ fontSize: 'clamp(2rem,4.5vw,3.2rem)', fontWeight: 800, color: '#0f172a', lineHeight: 1.15, marginBottom: '0.5rem' }}>
                SKM Physiotherapy<br /><span style={{ color: ACC }}>Sector 135, Noida</span>
              </h1>
        ...
        <section ref={ref('svc')} className={`rv ${vis('svc') ? 'in' : ''}`} style={{ background: '#f8fafc', padding: '4.5rem 1.5rem', borderTop: '1px solid #e2e8f0', borderBottom: '1px solid #e2e8f0' }}>
          <div style={{ maxWidth: 1200, margin: '0 auto' }}>
            ...
            <h2 className="bp1-display" style={{ fontSize: 'clamp(1.6rem,3vw,2.4rem)', fontWeight: 800, color: '#0f172a', marginTop: 4 }}>Services at Sector 135</h2>
            <div className="sdiv" />
          ...
          <div style={{ maxWidth: 1200, margin: '0 auto' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(280px,1fr))', gap: 24, alignItems: 'start' }}>
              <div style={{ borderRadius: 18, overflow: 'hidden', boxShadow: `0 8px 32px rgba(${RGB},0.12)`, border: `2px solid ${ACC}33` }}>
                <iframe src={BRANCH.mapEmbed} width="100%" height="340" style={{ border: 0, display: 'block' }} allowFullScreen loading="lazy" title="SKM Physiotherapy Sector 135 Map" />
              </div>
              <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
                {[
