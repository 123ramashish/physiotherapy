...
const HERO_IMAGES = [
    ...
    'https://images.unsplash.com/photo-1599447421416-3414500d18a5?w=1200&q=80',
...
const PROCESS_STEPS: ProcessStep[] = [
    {
        number: 1,
        titleEn: 'Postural Assessment',
        titleHi: 'आसन मूल्यांकन',
        descriptionEn: 'Evaluating spinal alignment and muscle imbalances.',
        descriptionHi: 'रीढ़ की हड्डी के संरेखण और मांसपेशियों के असंतुलन का मूल्यांकन।',
    ...
    },
    {
        ...
        descriptionHi: 'जोड़ों की गति को बहाल करने के लिए हाथों से की जाने वाली मोबिलाइजेशन।',
    ...
    {
        number: 3,
        titleEn: 'Core Activation',
        titleHi: 'कोर सक्रियण',
        descriptionEn: 'Specific exercises to stabilize the lumbar spine.',
        descriptionHi: 'लम्बर स्पाइन को स्थिर करने के लिए विशिष्ट व्यायाम।',
    ...
    {
        number: 4,
        titleEn: 'Pain Modalities',
        titleHi: 'दर्द निवारण तकनीक',
        descriptionEn: 'Advanced tech like Ultrasound or IFT for relief.',
        descriptionHi: 'राहत के लिए अल्ट्रासाउंड या आईएफटी जैसी उन्नत तकनीक।',
    ...
    },
    {
        ...
        titleHi: 'रखरखाव योजना',
        descriptionEn: 'Ergonomic advice and home exercise protocol.',
        descriptionHi: 'एर्गोनोमिक सलाह और होम एक्सरसाइज प्रोटोकॉल।',
...
const BENEFITS: Benefit[] = [
    {
        ...
        description: 'Targeted therapy to reduce acute inflammation and muscle spasms in the lower back.',
    ...
    },
    {
        ...
        description: 'Restores natural range of motion, allowing you to bend and twist without fear.',
    ...
    {
        title: 'Core Strength',
        description: 'Builds a "natural corset" of muscle to support your spine and prevent future injury.',
    ...
    },
    {
        ...
        description: 'Addresses the mechanical causes of back pain through postural re-education.',
    ...
    {
        title: 'Better Sleep',
        description: 'Reducing night-time discomfort leads to deeper, more restorative sleep cycles.',
    ...
    {
        title: 'Surgery Avoidance',
        description: 'Effective conservative management often eliminates the need for spinal surgery.',
...
const TESTIMONIALS: Testimonial[] = [
    {
        ...
        feedback: 'I was living on painkillers for my back. The core strengthening program at SKM changed everything. I am now back to my morning runs pain-free.',
        rating: 5,
    ...
    },
    {
        ...
        name: 'Anita Sharma',
        age: 48,
        condition: 'Slip Disc (L4-L5)',
        feedback: 'The manual therapy techniques used by the team are very effective. They helped me avoid surgery when other doctors were recommending it.',
        rating: 5,
...
const BEFORE_AFTER: BeforeAfter[] = [
    {
        ...
        condition: 'Chronic Slump Posture',
        sessions: 15,
        improvement: 'Aligned spinal posture',
        videoUrl: 'https://www.w3schools.com/html/mov_bbb.mp4'
    }
];

const STATS = [
    { number: '4,500+', label: 'Back Pain Patients', icon: <Users className="w-6 h-6" /> },
    { number: '18,000+', label: 'Sessions Done', icon: <Activity className="w-6 h-6" /> },
    { number: '94%', label: 'Relief Rate', icon: <Award className="w-6 h-6" /> },
    { number: '4.9★', label: 'Patient Rating', icon: <Star className="w-6 h-6" /> }
];

const CONDITIONS = [
    { en: 'Lumbar Spondylosis', hi: 'लम्बर स्पोंडिलोसिस' },
    { en: 'Slip Disc (PIVD)', hi: 'स्लिप डिस्क' },
    { en: 'Sciatica Pain', hi: 'साइटिका का दर्द' },
    { en: 'Muscle Strain', hi: 'मांसपेशियों में खिंचाव' },
    { en: 'Stenosis', hi: 'स्टेनोसिस' },
    { en: 'Ankylosing Spondylitis', hi: 'एंकिलॉजिंग स्पॉन्डिलाइटिस' },
    { en: 'Post-Surgical Recovery', hi: 'सर्जरी के बाद रिकवरी' },
    { en: 'Chronic Lower Back Pain', hi: 'पुराना कमर दर्द' }
];
...
export default function BackPainPage() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-blue-50/50 to-white">
            ...
            <nav className="bg-white border-b border-blue-100 py-3">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex items-center gap-2 text-sm flex-wrap">
                        {[{ label: 'Home', href: '/' }, { label: 'Services', href: '/services-skm-physiotherapy' }, { label: 'Back Pain', href: null }]
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-12 items-center">
                        <motion.div initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.6 }}>
                            <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/20 text-white rounded-full text-xs sm:text-sm font-medium mb-5 border border-white/30">
                                <Activity className="w-4 h-4" /> Comprehensive Spinal Care
                            </div>
                            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-5 leading-tight">
                                Back Pain Treatment
                                <span className="text-teal-200 block mt-2">Expert Spinal Solutions</span>
                            </h1>
                            <p className="text-base sm:text-lg text-blue-100 mb-7 leading-relaxed">
                                Specialized physiotherapy for acute and chronic back conditions. Rebuild your core, correct your posture, and reclaim your life without surgery.
                            </p>

                            <div className="flex flex-wrap items-center gap-4 sm:gap-6 text-xs sm:text-sm text-blue-100">
                                <div className="flex items-center gap-2"><CheckCircle className="w-4 h-4 sm:w-5 sm:h-5 text-emerald-400" /><span>Spinal Specialists</span></div>
                                <div className="flex items-center gap-2"><CheckCircle className="w-4 h-4 sm:w-5 sm:h-5 text-emerald-400" /><span>Advanced Pain Tech</span></div>
                            </div>
                        </motion.div>
                        ...
                        <motion.div initial={{ opacity: 0, x: 30 }} animate={{ opacity: 1, x: 0 }}
                            ...
                            <div className="bg-white/95 backdrop-blur rounded-2xl p-6 shadow-2xl">
                                <div className="flex items-center gap-4 mb-4">
                                    ...
                                    <div>
                                        <p className="text-2xl sm:text-3xl font-bold text-gray-900">4,500+</p>
                                        <p className="text-sm text-gray-500">Back Pain Patients Treated</p>
                                    </div>
                                </div>
                                <div className="grid grid-cols-3 gap-4 pt-4 border-t border-gray-100">
                                    <div className="text-center"><p className="text-lg sm:text-xl font-bold text-teal-600">18k+</p><p className="text-xs text-gray-500">Sessions</p></div>
                                    <div className="text-center"><p className="text-lg sm:text-xl font-bold text-teal-600">94%</p><p className="text-xs text-gray-500">Success</p></div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-12 items-center">
                        <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
                            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-5">Holistic Spinal Care</h2>
                            <div className="space-y-4 text-gray-600 leading-relaxed text-sm sm:text-base">
                                <p><strong className="text-gray-900">Back Pain Treatment</strong> at SKM goes beyond temporary relief. We focus on "Dynamic Stability"—ensuring your spine is both mobile and supported by strong deep-core muscles.</p>
                                <p>Whether you are dealing with a <strong className="text-gray-900">Slip Disc (PIVD)</strong> or chronic postural strain, our protocols integrate manual mobilization, electrotherapy, and progressive strengthening to ensure a lasting recovery.</p>
                                <p>Our therapists use evidence-based methods to decompress nerves, release tight tissues, and re-educate your posture for daily life.</p>
                            </div>
                            <div className="mt-7 space-y-2.5">
                                {['Lumbar Spine Mobilization', 'Neural Decompression Techniques', 'Core & Multifidus Strengthening', 'Ergonomic Workspace Assessment'].map((item, index) => (
                        ...
                        <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="grid grid-cols-2 gap-4">
                            <img src="https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=400&q=80" alt="Back assessment"
                                className="rounded-2xl shadow-lg w-full h-48 sm:h-64 object-cover" />
                            <img src="https://images.unsplash.com/photo-1551076805-e1869033e561?w=400&q=80" alt="Spinal therapy"
            ...
            <section className="py-14 sm:py-16 bg-gradient-to-b from-gray-50 to-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
                        ...
                        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-3">Benefits of Specialized Spine Care</h2>
                        <p className="text-gray-600 text-base sm:text-lg">Sustainable solutions for a pain-free, active back</p>
                    </motion.div>
            ...
            {/* Before/After */}
            <section className="py-14 sm:py-16 bg-gradient-to-b from-white to-teal-50/30">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
                        className="text-center max-w-3xl mx-auto mb-10 sm:mb-12">
                        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-3">Real Results: Before & After</h2>
                        <p className="text-gray-600 text-base sm:text-lg">See the postural and mobility gains of our spinal patients</p>
                    </motion.div>
                    <div className="relative">
                        <button onClick={() => scrollBeforeAfter('left')}
                            className="absolute left-0 top-1/2 -translate-y-1/2 z-10 w-10 h-10 sm:w-12 sm:h-12 bg-white rounded-full shadow-lg flex items-center justify-center text-gray-600 hover:text-teal-600 hover:shadow-xl transition-all border border-gray-200">
                        ...
                        <button onClick={() => scrollBeforeAfter('right')}
                            className="absolute right-0 top-1/2 -translate-y-1/2 z-10 w-10 h-10 sm:w-12 sm:h-12 bg-white rounded-full shadow-lg flex items-center justify-center text-gray-600 hover:text-teal-600 hover:shadow-xl transition-all border border-gray-200">
            ...
            <section className="py-14 sm:py-16 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
                        className="text-center max-w-3xl mx-auto mb-10 sm:mb-12">
                        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-3">Treatment Journey</h2>
                        <p className="text-gray-600 text-base sm:text-lg">Step-by-step path to spinal health and recovery</p>
                    </motion.div>
                            ...
                            <React.Fragment key={step.number}>
                                ...
                                {index < PROCESS_STEPS.length - 1 && (
                                    <div className="flex flex-col items-center py-2">
                                        <div className="w-0.5 h-3 bg-teal-200" />
                            ...
                            <React.Fragment key={step.number}>
                                ...
                                {index < PROCESS_STEPS.length - 1 && (
                                    <div className="flex flex-col items-center justify-center px-1 flex-shrink-0 gap-1 self-center">
                                        <div className="h-0.5 w-3 bg-teal-200" />
                                        <div className="w-9 h-9 rounded-full bg-teal-600 flex items-center justify-center shadow-md">
            ...
            <section className="py-14 sm:py-16 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
                        className="text-center max-w-3xl mx-auto mb-10 sm:mb-12">
                        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-3">Back Success Stories</h2>
                        <p className="text-gray-600 text-base sm:text-lg">Hear from patients who reclaimed their active lifestyle at SKM</p>
                    </motion.div>
                    <div className="relative">
                    ...
                    <div className="flex justify-center gap-2 mt-6">
                        {TESTIMONIALS.map((_, index) => (
                            <button key={index} onClick={() => setActiveTestimonial(index)}
                                className={`h-2.5 rounded-full transition-all duration-300 ${index === activeTestimonial ? 'bg-teal-600 w-7' : 'bg-gray-300 w-2.5'}`} />
                        ))}
                    </div>
                </div>
            </section>
            ...
            <section className="py-14 sm:py-16 bg-gradient-to-b from-teal-50/30 to-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
                        className="text-center max-w-3xl mx-auto mb-10 sm:mb-12">
                        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-3">Spinal Conditions We Treat</h2>
                        <p className="text-gray-500 text-sm sm:text-base">हम जो स्थितियां Treat करते हैं</p>
                        <p className="text-gray-600 text-base sm:text-lg mt-2">Expert care for all segments of back and lumbar pain</p>
                    </motion.div>
            ...
            <section className="py-14 sm:py-16 bg-white">
                <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="space-y-3 sm:space-y-4">
                        {[
                            { q: 'Can physiotherapy fix a slip disc?', a: 'While the disc bulge may not physically move back in all cases, physiotherapy can decompress the nerve, reduce inflammation, and strengthen the core to eliminate symptoms and allow normal life without surgery in 90% of cases.' },
                            { q: 'How many sessions do I need for back pain?', a: 'Acute muscle strains often resolve in 4-6 sessions. Chronic conditions or disc issues typically require 10-15 sessions for long-term stability and prevention of recurrence.' },
                            { q: 'Is bed rest good for back pain?', a: 'Prolonged bed rest is actually counterproductive. Modern research suggests staying as active as pain allows and starting gentle, specific movement as soon as possible.' },
                            { q: 'Do you use machines or manual therapy?', a: 'We use a combination. Manual therapy restores movement, while modalities (machines like Ultrasound/IFT) reduce pain and inflammation. Both are complemented by exercise therapy.' },
                            { q: 'Can poor posture cause back pain?', a: 'Absolutely. Chronic "slumping" puts excessive load on the lumbar spine and stretches muscles incorrectly. We provide specific postural re-education to reverse this damage.' }
