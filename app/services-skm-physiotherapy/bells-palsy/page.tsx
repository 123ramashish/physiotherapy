...
import {
    Brain, Heart, Activity, Clock, Shield, Award,
...
const PROCESS_STEPS: ProcessStep[] = [
    {
        number: 1,
        titleEn: 'Nerve Assessment',
        titleHi: 'तंत्रिका मूल्यांकन',
        descriptionEn: 'Expert evaluation of facial nerve function and grade of palsy.',
        descriptionHi: 'चेहरे की तंत्रिका कार्य और पालसी के ग्रेड का विशेषज्ञ मूल्यांकन।',
    ...
    },
    {
        number: 2,
        titleEn: 'EMS Therapy',
        titleHi: 'ईएमएस थेरेपी',
        descriptionEn: 'Electrical muscle stimulation to prevent muscle atrophy.',
        descriptionHi: 'मांसपेशियों के शोष को रोकने के लिए विद्युत मांसपेशी उत्तेजना।',
    ...
    },
    {
        ...
        titleHi: 'चेहरे की मालिश',
        descriptionEn: 'Stimulating circulation and reducing facial stiffness.',
        descriptionHi: 'रक्त संचार को उत्तेजित करना और चेहरे की जकड़न को कम करना।',
    ...
    {
        number: 4,
        titleEn: 'Bio-Feedback',
        titleHi: 'बायो-फीडबैक',
        descriptionEn: 'Mirror therapy and guided muscle re-education.',
        descriptionHi: 'मिरर थेरेपी और निर्देशित मांसपेशी पुन: शिक्षण।',
    ...
    {
        number: 5,
        titleEn: 'Home Exercises',
        titleHi: 'घर के व्यायाम',
        descriptionEn: 'Prescribed facial exercise protocol for daily recovery.',
        descriptionHi: 'दैनिक रिकवरी के लिए निर्धारित चेहरे के व्यायाम प्रोटोकॉल।',
...
const BENEFITS: Benefit[] = [
    {
        ...
        description: 'Stimulates the damaged facial nerve to accelerate natural healing and recovery of function.',
    ...
    },
    {
        ...
        description: 'Helps restore natural facial balance and prevents the "drooping" appearance over time.',
    ...
    },
    {
        ...
        description: 'Prevents facial muscle wasting (atrophy) while waiting for the nerve to recover.',
    ...
    },
    {
        ...
        description: 'Techniques and advice to ensure eye protection when lid closure is compromised.',
    ...
    },
    {
        ...
        description: 'Improves muscle coordination required for clear articulation and chewing.',
    ...
    },
    {
        ...
        description: 'Professional guidance to help cope with the physical changes during the recovery phase.',
...
const TESTIMONIALS: Testimonial[] = [
    {
        ...
        age: 42,
        condition: "Bell's Palsy (Right Side)",
        feedback: "I lost my smile overnight. The comprehensive EMS and bio-feedback therapy at SKM brought my facial movements back to 95% in just 6 weeks. Forever grateful.",
        rating: 5,
        image: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&q=80',
        sessionCount: 18,
        improvement: 'Near-total recovery'
    },
    {
        id: 2,
        name: 'Meera Kapoor',
        age: 31,
        condition: 'Facial Nerve Weakness',
        feedback: 'Very professional neuro-physiotherapists. They explained the process clearly and the results started appearing from the second week itself.',
        rating: 5,
        image: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=400&q=80',
        sessionCount: 10,
        improvement: 'Complete symmetry restored'
    }
];
...
const BEFORE_AFTER: BeforeAfter[] = [
    {
        id: 1,
        beforeImage: 'https://images.unsplash.com/photo-1559757175-5700dde675bc?w=600&q=80',
        afterImage: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=600&q=80',
        condition: 'Grade IV Bell\'s Palsy',
        sessions: 24,
        improvement: 'Full smile recovery',
        videoUrl: 'https://www.w3schools.com/html/mov_bbb.mp4'
    }
];

const STATS = [
    { number: '1,200+', label: 'Nerve Recoveries', icon: <Brain className="w-6 h-6" /> },
    { number: '5,000+', label: 'Therapy Hours', icon: <Activity className="w-6 h-6" /> },
    { number: '92%', label: 'Symmetry Rate', icon: <Award className="w-6 h-6" /> },
    { number: '4.9★', label: 'Expert Rating', icon: <Star className="w-6 h-6" /> }
];

const CONDITIONS = [
    { en: 'Bell\'s Palsy', hi: 'बेल का पक्षाघात' },
    { en: 'Ramsay Hunt Syndrome', hi: 'रमज़े हंट सिंड्रोम' },
    { en: 'Facial Nerve Trauma', hi: 'चेहरे की तंत्रिका में चोट' },
    { en: 'Post-Surgical Weakness', hi: 'सर्जरी के बाद की कमजोरी' },
    { en: 'Hemifacial Spasm', hi: 'हेमीफेशियल स्पस्म' },
    { en: 'Synkinesis', hi: 'सिनकिनेसिस' }
];
...
export default function BellsPalsyPage() {
        ...
        <div className="min-h-screen bg-gradient-to-b from-blue-50/50 to-white">
            ...
            <section className="relative pt-12 pb-16 sm:pt-16 sm:pb-20 overflow-hidden min-h-[520px] sm:min-h-[600px]">
                <div className="absolute inset-0">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-r from-indigo-900/85 via-blue-900/70 to-blue-900/75" />
                </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-12 items-center">
                        <motion.div initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.6 }}>
                            <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/20 text-white rounded-full text-xs sm:text-sm font-medium mb-5 border border-white/30">
                                <Brain className="w-4 h-4" /> Neuro-Rehabilitation Excellence
                            </div>
                            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-5 leading-tight">
                                Bell's Palsy Treatment
                                <span className="text-blue-200 block mt-2">Restore Your Smile</span>
                            </h1>
                            <p className="text-base sm:text-lg text-blue-100 mb-7 leading-relaxed">
                                Specialized neuro-physiotherapy for facial palsy including EMS, manual techniques, and facial re-education. 
                                Rebuild confidence and restore natural facial expressions.
                            </p>

                            <div className="flex flex-wrap items-center gap-4 sm:gap-6 text-xs sm:text-sm text-blue-100">
                                <div className="flex items-center gap-2"><CheckCircle className="w-4 h-4 sm:w-5 sm:h-5 text-emerald-400" /><span>Expert Neuro Therapists</span></div>
                                <div className="flex items-center gap-2"><CheckCircle className="w-4 h-4 sm:w-5 sm:h-5 text-emerald-400" /><span>Advanced EMS Tech</span></div>
                            </div>
                        </motion.div>
                            ...
                            <div className="bg-white/95 backdrop-blur rounded-2xl p-6 shadow-2xl">
                                <div className="flex items-center gap-4 mb-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-500">Successful Recoveries</p>
                                    </div>
                                </div>
                                <div className="grid grid-cols-3 gap-4 pt-4 border-t border-gray-100">
                                    <div className="text-center"><p className="text-lg sm:text-xl font-bold text-blue-600">92%</p><p className="text-xs text-gray-500">Symmetry</p></div>
                                    <div className="text-center"><p className="text-lg sm:text-xl font-bold text-blue-600">5k+</p><p className="text-xs text-gray-500">Hours</p></div>
            ...
            {/* Stats Bar */}
            <section className="py-10 sm:py-12 bg-gradient-to-r from-indigo-600 to-blue-700">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-12 items-center">
                        <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
                            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-5">Understanding Bell's Palsy Recovery</h2>
                            <div className="space-y-4 text-gray-600 leading-relaxed text-sm sm:text-base">
                                <p><strong className="text-gray-900">Bell's Palsy</strong> is a sudden weakness or paralysis of the facial muscles, typically on one side of the face, caused by inflammation of the 7th cranial nerve.</p>
                                <p>At SKM Physiotherapy, our <strong className="text-gray-900">Neuro-Physiotherapy protocol</strong> is designed to stimulate nerve regeneration while keeping the facial muscles active and healthy through advanced EMS and specialized manual therapy.</p>
                                <p>Early intervention is crucial to achieve maximum symmetry and prevent long-term complications like synkinesis or permanent contractures.</p>
                            </div>
                            <div className="mt-7 space-y-2.5">
                                {['Diagnostic Nerve Assessment', 'Clinical Grade EMS Therapy', 'Proprioceptive Neuromuscular Facilitation (PNF)', 'Therapeutic Facial Massage'].map((item, index) => (
                                    <div key={index} className="flex items-center gap-3">
                                        <div className="w-5 h-5 sm:w-6 sm:h-6 rounded-full bg-indigo-100 flex items-center justify-center flex-shrink-0">
                                            <CheckCircle className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-indigo-600" />
                                        </div>
                        ...
                        <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="grid grid-cols-2 gap-4">
                            <img src="https://images.unsplash.com/photo-1559757175-5700dde675bc?w=400&q=80" alt="Facial assessment"
                                className="rounded-2xl shadow-lg w-full h-48 sm:h-64 object-cover" />
                            <img src="https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?w=400&q=80" alt="EMS therapy"
            ...
            <section className="py-14 sm:py-16 bg-gradient-to-b from-gray-50 to-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
                        ...
                        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-3">Benefits of Specialized Neuro Care</h2>
                        <p className="text-gray-600 text-base sm:text-lg">Targeted results for facial nerve health and muscle function</p>
                    </motion.div>
            ...
            {/* Before/After */}
            <section className="py-14 sm:py-16 bg-gradient-to-b from-white to-indigo-50/30">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
                        className="text-center max-w-3xl mx-auto mb-10 sm:mb-12">
                        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-3">Real Results: Before & After</h2>
                        <p className="text-gray-600 text-base sm:text-lg">See the recovery journey of our facial palsy patients</p>
                    </motion.div>
            ...
            <section className="py-14 sm:py-16 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
                        className="text-center max-w-3xl mx-auto mb-10 sm:mb-12">
                        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-3">Recovery Process</h2>
                        <p className="text-gray-600 text-base sm:text-lg">Our systematic approach to facial re-education</p>
                    </motion.div>
            ...
            <section className="py-14 sm:py-16 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
                        className="text-center max-w-3xl mx-auto mb-10 sm:mb-12">
                        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-3">Success Stories</h2>
                        <p className="text-gray-600 text-base sm:text-lg">Hear from patients who regained their smiles at SKM</p>
                    </motion.div>
                    <div className="relative">
                    ...
                    <div className="flex justify-center gap-2 mt-6">
                        {TESTIMONIALS.map((_, index) => (
                            <button key={index} onClick={() => setActiveTestimonial(index)}
                                className={`h-2.5 rounded-full transition-all duration-300 ${index === activeTestimonial ? 'bg-indigo-600 w-7' : 'bg-gray-300 w-2.5'}`} />
                        ))}
                    </div>
                </div>
            </section>
            ...
            {/* Conditions Treated */}
            <section className="py-14 sm:py-16 bg-gradient-to-b from-indigo-50/30 to-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
                        className="text-center max-w-3xl mx-auto mb-10 sm:mb-12">
                        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-3">Neurological Conditions</h2>
                        <p className="text-gray-500 text-sm sm:text-base">हम जो स्थितियां Treat करते हैं</p>
                        <p className="text-gray-600 text-base sm:text-lg mt-2">Specialized therapy for various facial nerve issues</p>
                    </motion.div>
            ...
            <section className="py-14 sm:py-16 bg-white">
                <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="space-y-3 sm:space-y-4">
                        {[
                            { q: 'How long does Bell\'s Palsy recovery take?', a: 'Most people start to see improvement within 2 to 3 weeks, but complete recovery can take anywhere from 3 to 6 months. Consistent physiotherapy significantly improves the quality of recovery.' },
                            { q: 'Is electrical stimulation (EMS) painful?', a: 'No, EMS feels like a mild tingling or pulsing sensation. It is adjusted to your comfort level and is essential for keeping the muscles alive while the nerve heals.' },
                            { q: 'Can I do the exercises at home?', a: 'Yes, we provide a structured home exercise plan. However, clinical supervision is needed for correct technique and advanced modalities like EMS or PNF.' },
                            { q: 'What is Synkinesis?', a: 'Synkinesis is a common complication where nerves regrow incorrectly, causing unwanted movements (e.g., eye closing when you smile). Our specialized therapy helps prevent and manage this.' },
                            { q: 'Should I use a heat pack or ice?', a: 'Generally, moist heat is recommended to improve circulation and relax muscles, but please consult our therapists for a personalized recommendation based on your current stage.' }
