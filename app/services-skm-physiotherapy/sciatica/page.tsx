...
import {
    Zap, Heart, Activity, Clock, Shield, Award,
...
const PROCESS_STEPS: ProcessStep[] = [
    {
        number: 1,
        titleEn: 'Neural Screening',
        titleHi: 'तंत्रिका स्क्रीनिंग',
        descriptionEn: 'SLR test and physical assessment to locate nerve impingement.',
        descriptionHi: 'तंत्रिका अवरोध का पता लगाने के लिए एसएलआर परीक्षण और शारीरिक मूल्यांकन।',
    ...
    {
        number: 2,
        titleEn: 'Spinal Decompression',
        titleHi: 'स्पाइनल डिकंप्रेशन',
        descriptionEn: 'Manual techniques to create space and reduce disc pressure.',
        descriptionHi: 'जगह बनाने और डिस्क दबाव को कम करने के लिए मैनुअल तकनीकें।',
    ...
    {
        number: 3,
        titleEn: 'Neural Flossing',
        titleHi: 'तंत्रिका फ्लॉसिंग',
        descriptionEn: 'Specialized mobilization to improve sciatic nerve glide.',
        descriptionHi: 'साइटिक तंत्रिका ग्लाइड को बेहतर बनाने के लिए विशेष मोबिलाइजेशन।',
    ...
    {
        number: 4,
        titleEn: 'Stability Protocol',
        titleHi: 'स्थिरता प्रोटोकॉल',
        descriptionEn: 'Core and glute activation to protect the lower spine.',
        descriptionHi: 'निचली रीढ़ की सुरक्षा के लिए कोर और ग्लूट सक्रियण।',
    ...
    {
        number: 5,
        titleEn: 'Self-Care Plan',
        titleHi: 'स्वयं की देखभाल योजना',
        descriptionEn: 'Stretching and ergonomic guidance for daily life.',
        descriptionHi: 'दैनिक जीवन के लिए स्ट्रेचिंग और एर्गोनोमिक मार्गदर्शन।',
...
const BENEFITS: Benefit[] = [
    {
        title: 'End Leg Pain',
        description: 'Rapidly reduces the shooting pain, numbness, and tingling that travels down the leg.',
    ...
    {
        title: 'Nerve Health',
        description: 'Improves circulation around the sciatic nerve, promoting its natural repair and function.',
    ...
    },
    {
        ...
        description: 'Gets you walking and sitting comfortably again by freeing up restricted neural pathways.',
    ...
    {
        title: 'Disc Recovery',
        description: 'Addresses the common cause of sciatica by relieving pressure on spinal discs.',
    ...
    },
    {
        ...
        description: 'Prevents leg muscle weakness and "foot drop" by ensuring proper nerve signals.',
    ...
    },
    {
        ...
        description: 'Strengthens the core and back to prevent future episodes of nerve compression.',
...
const TESTIMONIALS: Testimonial[] = [
    {
        ...
        name: 'Arjun Kapoor',
        age: 41,
        condition: 'L5-S1 Sciatica',
        feedback: 'The "Neural Flossing" exercises and decompression techniques were life-changing. I had pain down to my toes for 3 months; it was gone in 12 sessions.',
        rating: 5,
...
const BEFORE_AFTER: BeforeAfter[] = [
    {
        ...
        condition: 'Lumbar Flexion Recovery',
        sessions: 10,
        improvement: 'Full painless bending',
        videoUrl: 'https://www.w3schools.com/html/mov_bbb.mp4'
    }
];

const STATS = [
    { number: '1,800+', label: 'Sciatica Recoveries', icon: <Users className="w-6 h-6" /> },
    { number: '7,500+', label: 'Hours of Therapy', icon: <Activity className="w-6 h-6" /> },
    { number: '93%', label: 'Relief Rate', icon: <Award className="w-6 h-6" /> },
    { number: '4.9★', label: 'Patient Rating', icon: <Star className="w-6 h-6" /> }
];

const CONDITIONS = [
    { en: 'Lumbar Disc Bulge', hi: 'लम्बर डिस्क उभार' },
    { en: 'Piriformis Syndrome', hi: 'पिरिफोर्मिस सिंड्रोम' },
    { en: 'Spondylolisthesis', hi: 'स्पोंडिलोलिस्थीसिस' },
    { en: 'Spinal Stenosis', hi: 'स्पाइनल स्टेनोसिस' },
    { en: 'Nerve Root Compression', hi: 'तंत्रिका जड़ संपीड़न' },
    { en: 'Post-Pregnancy Sciatica', hi: 'गर्भावस्था के बाद साइटिका' }
];
...
export default function SciaticaPainPage() {
        ...
        <div className="min-h-screen bg-gradient-to-b from-blue-50/50 to-white">
            ...
            <nav className="bg-white border-b border-blue-100 py-3">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex items-center gap-2 text-sm flex-wrap">
                        {[{ label: 'Home', href: '/' }, { label: 'Services', href: '/services-skm-physiotherapy' }, { label: 'Sciatica Pain', href: null }]
            ...
            <section className="relative pt-12 pb-16 sm:pt-16 sm:pb-20 overflow-hidden min-h-[520px] sm:min-h-[600px]">
                <div className="absolute inset-0">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-r from-emerald-900/85 via-emerald-900/70 to-blue-900/75" />
                </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-12 items-center">
                        <motion.div initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.6 }}>
                            <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/20 text-white rounded-full text-xs sm:text-sm font-medium mb-5 border border-white/30">
                                <Zap className="w-4 h-4" /> Specialist Nerve Care
                            </div>
                            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-5 leading-tight">
                                Sciatica Pain Relief
                                <span className="text-emerald-200 block mt-2">End Leg Pain & Numbness</span>
                            </h1>
                            <p className="text-base sm:text-lg text-blue-100 mb-7 leading-relaxed">
                                Sciatica nerve pain relief through clinical decompression, neural mobilization, and core strengthening. Expertly designed protocols to free you from shooting pain.
                            </p>

                            <div className="flex flex-wrap items-center gap-4 sm:gap-6 text-xs sm:text-sm text-blue-100">
                                <div className="flex items-center gap-2"><CheckCircle className="w-4 h-4 sm:w-5 sm:h-5 text-emerald-400" /><span>Neural Decompression</span></div>
                            ...
                            <div className="bg-white/95 backdrop-blur rounded-2xl p-6 shadow-2xl">
                                <div className="flex items-center gap-4 mb-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-500">Sciatica Recoveries</p>
                                    </div>
                                </div>
                                <div className="grid grid-cols-3 gap-4 pt-4 border-t border-gray-100">
                                    <div className="text-center"><p className="text-lg sm:text-xl font-bold text-emerald-600">93%</p><p className="text-xs text-gray-500">Success</p></div>
                                    <div className="text-center"><p className="text-lg sm:text-xl font-bold text-emerald-600">7.5k+</p><p className="text-xs text-gray-500">Sessions</p></div>
                                    <div className="text-center"><p className="text-lg sm:text-xl font-bold text-emerald-600">4.9★</p><p className="text-xs text-gray-500">Rating</p></div>
                                </div>
                            </div>
                        </motion.div>
                    </div>
            ...
            {/* Stats Bar */}
            <section className="py-10 sm:py-12 bg-gradient-to-r from-emerald-600 to-blue-700">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-12 items-center">
                        <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
                            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-5">Free the Nerve</h2>
                            <div className="space-y-4 text-gray-600 leading-relaxed text-sm sm:text-base">
                                <p><strong className="text-gray-900">Sciatica</strong> occurs when the sciatic nerve is compressed, typically by a herniated disc or bone spur. This causes radiating pain that travels from your lower back down through your hips and buttocks and into each leg.</p>
                                <p>Our <strong className="text-gray-900">Specialized Nerve Care</strong> focuses on clinical decompression and "Neural Flossing"—a technique to gently mobilize the nerve through its pathways to break adhesions and restore painless movement.</p>
                                <p>We combine these manual techniques with deep-core stability protocols to ensure the spine is supported and the nerve stays free of pressure.</p>
                            </div>
                            <div className="mt-7 space-y-2.5">
                                {['Diagnostic Neurological Testing', 'Clinical Spinal Decompression', 'Sciatic Nerve Mobilization (Flossing)', 'Lumbar-Pelvic Stability Training'].map((item, index) => (
                        ...
                        <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="grid grid-cols-2 gap-4">
                            <img src="https://images.unsplash.com/photo-1544161515-4ab6ce6db874?w=400&q=80" alt="Nerve assessment"
                                className="rounded-2xl shadow-lg w-full h-48 sm:h-64 object-cover" />
                            <img src="https://images.unsplash.com/photo-1551076805-e1869033e561?w=400&q=80" alt="Neural therapy"
            ...
            <section className="py-14 sm:py-16 bg-gradient-to-b from-gray-50 to-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
                        ...
                        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-3">Benefits of Sciatica Therapy</h2>
                        <p className="text-gray-600 text-base sm:text-lg">Specialized care to restore nerve function and end leg pain</p>
                    </motion.div>
            ...
            {/* Before/After */}
            <section className="py-14 sm:py-16 bg-gradient-to-b from-white to-emerald-50/30">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
                        className="text-center max-w-3xl mx-auto mb-10 sm:mb-12">
                        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-3">Real Results: Before & After</h2>
                        <p className="text-gray-600 text-base sm:text-lg">Witness the functional recovery of our sciatica patients</p>
                    </motion.div>
                    <div className="relative">
                        <button onClick={() => scrollBeforeAfter('left')}
                            className="absolute left-0 top-1/2 -translate-y-1/2 z-10 w-10 h-10 sm:w-12 sm:h-12 bg-white rounded-full shadow-lg flex items-center justify-center text-gray-600 hover:text-emerald-600 hover:shadow-xl transition-all border border-gray-200">
                        ...
                        <button onClick={() => scrollBeforeAfter('right')}
                            className="absolute right-0 top-1/2 -translate-y-1/2 z-10 w-10 h-10 sm:w-12 sm:h-12 bg-white rounded-full shadow-lg flex items-center justify-center text-gray-600 hover:text-emerald-600 hover:shadow-xl transition-all border border-gray-200">
            ...
            <section className="py-14 sm:py-16 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
                        className="text-center max-w-3xl mx-auto mb-10 sm:mb-12">
                        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-3">The Recovery Process</h2>
                        <p className="text-gray-600 text-base sm:text-lg">Systematic approach to decompress the sciatic nerve</p>
                    </motion.div>
                            ...
                            <React.Fragment key={step.number}>
                                ...
                                {index < PROCESS_STEPS.length - 1 && (
                                    <div className="flex flex-col items-center py-2">
                                        <div className="w-0.5 h-3 bg-emerald-200" />
                                        <div className="w-9 h-9 rounded-full bg-emerald-600 flex items-center justify-center shadow-md">
                            ...
                            <React.Fragment key={step.number}>
                                ...
                                {index < PROCESS_STEPS.length - 1 && (
                                    <div className="flex flex-col items-center justify-center px-1 flex-shrink-0 gap-1 self-center">
                                        <div className="h-0.5 w-3 bg-emerald-200" />
                                        <div className="w-9 h-9 rounded-full bg-emerald-600 flex items-center justify-center shadow-md">
            ...
            <section className="py-14 sm:py-16 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
                        className="text-center max-w-3xl mx-auto mb-10 sm:mb-12">
                        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-3">Sciatica Success Stories</h2>
                        <p className="text-gray-600 text-base sm:text-lg">Hear from patients who escaped chronic radiating pain</p>
                    </motion.div>
                    <div className="relative">
                    ...
                    <div className="flex justify-center gap-2 mt-6">
                        {TESTIMONIALS.map((_, index) => (
                            <button key={index} onClick={() => setActiveTestimonial(index)}
                                className={`h-2.5 rounded-full transition-all duration-300 ${index === activeTestimonial ? 'bg-emerald-600 w-7' : 'bg-gray-300 w-2.5'}`} />
                        ))}
                    </div>
                </div>
            </section>
            ...
            {/* Conditions Treated */}
            <section className="py-14 sm:py-16 bg-gradient-to-b from-emerald-50/30 to-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
                        className="text-center max-w-3xl mx-auto mb-10 sm:mb-12">
                        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-3">Nerve Conditions We Treat</h2>
                        <p className="text-gray-500 text-sm sm:text-base">हम जो स्थितियां Treat करते हैं</p>
                        <p className="text-gray-600 text-base sm:text-lg mt-2">Expert care for various forms of sciatic and radiating nerve pain</p>
                    </motion.div>
            ...
            <section className="py-14 sm:py-16 bg-white">
                <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="space-y-3 sm:space-y-4">
                        {[
                            { q: 'Can sciatica be cured without surgery?', a: 'Yes, the vast majority of sciatica cases (over 90%) resolve with consistent, specialized physiotherapy involving neural decompression and targeted strengthening exercises.' },
                            { q: 'Is it sciatica if the pain is only in my hip?', a: 'Sciatica typically radiates past the knee, but compression high up in the lumbar spine or in the gluteal region (Piriformis Syndrome) can cause localized hip and buttock pain. A clinical assessment is needed for diagnosis.' },
                            { q: 'Should I use heat or ice for sciatica?', a: 'Initially, ice can help reduce inflammation at the source of compression in the lower back. However, for chronic nerve pain, moist heat is often more effective at relaxing the surrounding muscle guarding.' },
                            { q: 'Can I exercise during a sciatica flare-up?', a: 'We recommend gentle movements and specific "nerve glides" that we teach in the clinic. High-impact exercises or heavy lifting should be avoided until the acute compression is resolved.' },
                            { q: 'What is "Neural Flossing"?', a: 'It is a specific mobilization technique that slides the nerve back and forth through its anatomical tunnels, helping to break down adhesions and reduce sensitivity.' }
            ...
            <section className="py-16 bg-gradient-to-r from-emerald-600 to-blue-700 text-white">
                <div className="max-w-4xl mx-auto px-4 text-center">
                    <h2 className="text-3xl sm:text-4xl font-bold mb-4 text-white">Ready to Live Pain-Free?</h2>
                    <p className="text-emerald-50 mb-8 text-lg opacity-90">Book your clinical assessment today and start your journey to lasting relief from sciatica.</p>
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <a href="/contact-skm-physiotherapy" className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-white text-emerald-600 rounded-xl font-bold hover:bg-emerald-50 transition-colors shadow-lg">
                            Book Clinical Assessment <ArrowRight className="w-5 h-5" />
                        </a>
                        <a href="tel:+917542918414" className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-emerald-500 text-white rounded-xl font-bold hover:bg-emerald-400 transition-colors border border-emerald-400">
                            <Phone className="w-5 h-5" /> Call Nerve Specialist
                        </a>
                    </div>
                </div>
            </section>
