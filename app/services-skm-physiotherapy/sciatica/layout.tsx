...
export const metadata: Metadata = {
  title: "Sciatica Treatment in Noida, Greater Noida & Gurugram | SKM Physiotherapy",
  description:
    "Effective sciatica pain treatment without surgery at SKM Physiotherapy across Noida, Greater Noida & Gurugram. Expert physiotherapy for sciatic nerve pain, leg numbness, buttock pain & radiating back pain. Certified therapists. Book free consultation.",
  keywords: [
