...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://www.skmphysiotherapy.com/services-skm-physiotherapy/corporate",
    siteName: "SKM Physiotherapy & Rehabilitation Centre",
    images: [{ url: "https://www.skmphysiotherapy.com/og-corporate.jpg", width: 1200, height: 630, alt: "Corporate Office Physiotherapy and Workplace Wellness by SKM — Noida and Gurugram" }],
    locale: "en_IN", type: "website",
  },
  twitter: { card: "summary_large_image", title: "Corporate Office Physiotherapy | SKM — Noida & Gurugram", description: "On-site ergonomics, RSI prevention & employee wellness for companies in Noida, Greater Noida & Gurugram.", images: ["https://www.skmphysiotherapy.com/og-corporate.jpg"], creator: "@skmphysio" },
  alternates: { canonical: "https://www.skmphysiotherapy.com/services-skm-physiotherapy/corporate" },
  ...
  "@graph": [
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 3, name: "Corporate Physiotherapy", item: "https://www.skmphysiotherapy.com/services-skm-physiotherapy/corporate" },
      ],
    },
  ],
};
