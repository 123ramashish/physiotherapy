...
import {
    Target, Heart, Activity, Clock, Shield, Award,
...
const PROCESS_STEPS: ProcessStep[] = [
    {
        number: 1,
        titleEn: 'Capsular Assessment',
        titleHi: 'कैप्सुलर मूल्यांकन',
        descriptionEn: 'Evaluating the specific pattern of restriction in the shoulder capsule.',
        descriptionHi: 'कंधे के कैप्सूल में प्रतिबंध के विशिष्ट पैटर्न का मूल्यांकन।',
    ...
    {
        number: 2,
        titleEn: 'Pain Reduction',
        titleHi: 'दर्द निवारण',
        descriptionEn: 'Using clinical modalities to reduce deep-seated shoulder ache.',
        descriptionHi: 'कंधे के गहरे दर्द को कम करने के लिए नैदानिक तकनीकों का उपयोग करना।',
    ...
    },
    {
        ...
        descriptionEn: 'Grade-specific manual gliding to stretch the tight capsule.',
        descriptionHi: 'कसे हुए कैप्सूल को खींचने के लिए विशिष्ट मैनुअल तकनीकें।',
    ...
    {
        number: 4,
        titleEn: 'Range Exercises',
        titleHi: 'रेंज व्यायाम',
        descriptionEn: 'Pendulum and pulley exercises to maintain new mobility.',
        descriptionHi: 'नई गतिशीलता बनाए रखने के लिए पेंडुलम और पुली व्यायाम।',
        icon: <Activity className="w-6 h-6" />,
        duration: '20 mins',
    ...
    {
        number: 5,
        titleEn: 'Scapular Stability',
        titleHi: 'स्कैपुलर स्थिरता',
        descriptionEn: 'Strengthening shoulder blade muscles to ensure healthy movement.',
        descriptionHi: 'स्वस्थ गति सुनिश्चित करने के लिए कंधे की मांसपेशियों को मजबूत करना।',
...
const BENEFITS: Benefit[] = [
    {
        title: 'Restored Motion',
        description: 'Systematically regains the ability to reach overhead, behind the back, and out to the side.',
    ...
    {
        title: 'End Night Pain',
        description: 'Targeted therapy to resolve the characteristic "throbbing" pain that interrupts sleep.',
    ...
    {
        title: 'Capsule Stretching',
        description: 'Professional mobilization techniques to safely stretch the thickened shoulder lining.',
    ...
    {
        title: 'Improved Dressing',
        description: 'Focuses on the functional movements required for daily tasks like wearing a shirt or combing hair.',
    ...
    {
        title: 'Avoid Manipulation',
        description: 'Effective conservative care can often avoid the need for aggressive "Manipulation Under Anesthesia".',
    ...
    {
        title: 'Posture Integration',
        description: 'Addresses the postural slumping that often accompanies and worsens frozen shoulder.',
...
const TESTIMONIALS: Testimonial[] = [
    {
        ...
        feedback: 'I couldn\'t even lift my hand to brush my teeth. After 3 months of regular mobilization at SKM, I have 90% of my range back. It takes patience but the results are amazing.',
        rating: 5,
        image: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&q=80',
        sessionCount: 24,
        improvement: 'Full functional reach'
    }
];
...
const BEFORE_AFTER: BeforeAfter[] = [
    {
        id: 1,
        beforeImage: 'https://images.unsplash.com/photo-1519494026892-80bbd2d6fd0d?w=600&q=80',
        afterImage: 'https://images.unsplash.com/photo-1544161515-4ab6ce6db874?w=600&q=80',
        condition: 'Shoulder Abduction Range',
        sessions: 15,
        improvement: 'Range increased by 60 degrees',
        videoUrl: 'https://www.w3schools.com/html/mov_bbb.mp4'
    }
];

const STATS = [
    { number: '1,400+', label: 'Shoulders Restored', icon: <Target className="w-6 h-6" /> },
    { number: '7,000+', label: 'Mobilization Hours', icon: <Activity className="w-6 h-6" /> },
    { number: '89%', label: 'Range Recovery', icon: <Award className="w-6 h-6" /> },
    { number: '4.8★', label: 'Patient Rating', icon: <Star className="w-6 h-6" /> }
];

const CONDITIONS = [
    { en: 'Adhesive Capsulitis', hi: 'एडहेसिव कैप्सुलाइटिस' },
    { en: 'Frozen Shoulder (Stage 1-3)', hi: 'फ्रोजन शोल्डर' },
    { en: 'Post-Surgical Stiffness', hi: 'सर्जरी के बाद की जकड़न' },
    { en: 'Rotator Cuff Tendonitis', hi: 'रोटेटर कफ टेंडोनाइटिस' },
    { en: 'Bicipital Tenosynovitis', hi: 'बाइसिटल टेनोसिनोवाइटिस' },
    { en: 'Subacromial Bursitis', hi: 'सबएक्रोमियल बर्साइटिस' }
];
        ...
        <div className="min-h-screen bg-gradient-to-b from-blue-50/50 to-white">
            ...
            <nav className="bg-white border-b border-blue-100 py-3">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex items-center gap-2 text-sm flex-wrap">
                        {[{ label: 'Home', href: '/' }, { label: 'Services', href: '/services-skm-physiotherapy' }, { label: 'Frozen Shoulder', href: null }]
            ...
            <section className="relative pt-12 pb-16 sm:pt-16 sm:pb-20 overflow-hidden min-h-[520px] sm:min-h-[600px]">
                <div className="absolute inset-0">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-r from-blue-900/85 via-blue-900/70 to-blue-900/75" />
                </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-12 items-center">
                        <motion.div initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.6 }}>
                            <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/20 text-white rounded-full text-xs sm:text-sm font-medium mb-5 border border-white/30">
                                <Target className="w-4 h-4" /> Expert Shoulder Restoration
                            </div>
                            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-5 leading-tight">
                                Frozen Shoulder Rehab
                                <span className="text-blue-200 block mt-2">कंधे की जकड़न - Regain Your Range</span>
                            </h1>
                            <p className="text-base sm:text-lg text-blue-100 mb-7 leading-relaxed">
                                Professional treatment for Adhesive Capsulitis. Restore full range of motion, end night pain, and return to your daily activities with our specialized manual therapy.
                            </p>

                            <div className="flex flex-wrap items-center gap-4 sm:gap-6 text-xs sm:text-sm text-blue-100">
                                <div className="flex items-center gap-2"><CheckCircle className="w-4 h-4 sm:w-5 sm:h-5 text-emerald-400" /><span>Capsular Release Specialists</span></div>
                                <div className="flex items-center gap-2"><CheckCircle className="w-4 h-4 sm:w-5 sm:h-5 text-emerald-400" /><span>Clinical Grade Modalities</span></div>
                            </div>
                        </motion.div>
                        ...
                        <motion.div initial={{ opacity: 0, x: 30 }} animate={{ opacity: 1, x: 0 }}
                            ...
                            <div className="bg-white/95 backdrop-blur rounded-2xl p-6 shadow-2xl">
                                <div className="flex items-center gap-4 mb-4">
                                    ...
                                    <div>
                                        <p className="text-2xl sm:text-3xl font-bold text-gray-900">1,400+</p>
                                        <p className="text-sm text-gray-500">Shoulders Restored</p>
                                    </div>
                                </div>
                                <div className="grid grid-cols-3 gap-4 pt-4 border-t border-gray-100">
                                    <div className="text-center"><p className="text-lg sm:text-xl font-bold text-blue-600">89%</p><p className="text-xs text-gray-500">Recovery</p></div>
                                    <div className="text-center"><p className="text-lg sm:text-xl font-bold text-blue-600">7k+</p><p className="text-xs text-gray-500">Sessions</p></div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-12 items-center">
                        <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
                            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-5">Unlocking the Joint</h2>
                            <div className="space-y-4 text-gray-600 leading-relaxed text-sm sm:text-base">
                                <p><strong className="text-gray-900">Adhesive Capsulitis</strong> (Frozen Shoulder) involves the thickening and tightening of the shoulder capsule. At SKM Physiotherapy, we understand the stages of this condition—from the initial "Freezing" phase to the stubborn "Frozen" stage.</p>
                                <p>Our treatment focuses on <strong className="text-gray-900">Graded Joint Mobilization</strong>. We use manual techniques to gently glide the joint surfaces, creating the space needed for the capsule to stretch safely and without causing further inflammation.</p>
                                <p>We combine these clinical sessions with a highly specific home exercise program to ensure the range gained in the clinic is maintained throughout your day.</p>
                            </div>
                            <div className="mt-7 space-y-2.5">
                                {['Stage-Specific Mobilization Techniques', 'Clinical Pain & Inflammation Control', 'Scapulo-Humeral Rhythm Correction', 'Progressive Range-of-Motion Exercises'].map((item, index) => (
                        ...
                        <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="grid grid-cols-2 gap-4">
                            <img src="https://images.unsplash.com/photo-1544161515-4ab6ce6db874?w=400&q=80" alt="Shoulder assessment"
                                className="rounded-2xl shadow-lg w-full h-48 sm:h-64 object-cover" />
                            <img src="https://images.unsplash.com/photo-1519494026892-80bbd2d6fd0d?w=400&q=80" alt="Shoulder rehab"
            ...
            <section className="py-14 sm:py-16 bg-gradient-to-b from-gray-50 to-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
                        ...
                        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-3">Reclaim Your Range</h2>
                        <p className="text-gray-600 text-base sm:text-lg">Specialized benefits for complete shoulder restoration</p>
                    </motion.div>
            ...
            <section className="py-14 sm:py-16 bg-gradient-to-b from-white to-blue-50/30">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
                        ...
                        <p className="text-gray-600 text-base sm:text-lg">Witness the mobility improvements of our shoulder patients</p>
                    </motion.div>
            ...
            <section className="py-14 sm:py-16 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
                        ...
                        <p className="text-gray-600 text-base sm:text-lg">Step-by-step path to an active, mobile shoulder</p>
                    </motion.div>
            ...
            <section className="py-14 sm:py-16 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
                        className="text-center max-w-3xl mx-auto mb-10 sm:mb-12">
                        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-3">Shoulder Success Stories</h2>
                        <p className="text-gray-600 text-base sm:text-lg">Hear from patients who regained their freedom of movement</p>
                    </motion.div>
                    <div className="relative">
            ...
            <section className="py-14 sm:py-16 bg-gradient-to-b from-blue-50/30 to-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
                        className="text-center max-w-3xl mx-auto mb-10 sm:mb-12">
                        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-3">Shoulder Conditions We Treat</h2>
                        <p className="text-gray-500 text-sm sm:text-base">हम जो स्थितियां Treat करते हैं</p>
                        <p className="text-gray-600 text-base sm:text-lg mt-2">Specialized care for various capsular and rotator cuff issues</p>
                    </motion.div>
            ...
            <section className="py-14 sm:py-16 bg-white">
                <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="space-y-3 sm:space-y-4">
                        {[
                            { q: 'How long does frozen shoulder take to heal?', a: 'Frozen shoulder typically follows a Stage-based timeline. With consistent physiotherapy, we can often resolve the stiffness in 4 to 6 months, whereas without treatment it could take 1-2 years.' },
                            { q: 'Is it better to keep moving or to rest?', a: 'Relative rest is needed during the acute "freezing" phase, but gentle, specific mobilization is essential to prevent permanent stiffness. We provide the exact movements safe for your current stage.' },
                            { q: 'Can I avoid surgery?', a: 'Yes. Most cases of frozen shoulder respond very well to conservative management through physiotherapy. Surgery is usually considered only as a last resort.' },
                            { q: 'Why is the pain worse at night?', a: 'Inflammation in the shoulder capsule often settles when you are lying down, increasing the internal pressure. We provide specific sleeping positions to help reduce this discomfort.' },
                            { q: 'What is Capsular Stretching?', a: 'It is a skilled manual technique where the therapist applies gentle pressure to move the bone within the joint, helping to stretch the thickened joint capsule.' }
            ...
            <section className="py-16 bg-gradient-to-r from-blue-600 to-indigo-700 text-white">
                <div className="max-w-4xl mx-auto px-4 text-center">
                    <h2 className="text-3xl sm:text-4xl font-bold mb-4 text-white">Unlock Your Shoulder</h2>
                    <p className="text-blue-50 mb-8 text-lg opacity-90">Don't let shoulder stiffness limit your life. Book your clinical assessment today.</p>
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <a href="/contact-skm-physiotherapy" className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-white text-blue-600 rounded-xl font-bold hover:bg-blue-50 transition-colors shadow-lg">
                            Book Shoulder Assessment <ArrowRight className="w-5 h-5" />
                        </a>
                        <a href="tel:+917982799147" className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-blue-500 text-white rounded-xl font-bold hover:bg-blue-400 transition-colors border border-blue-400">
                            <Phone className="w-5 h-5" /> Call Shoulder Specialist
                        </a>
                    </div>
                </div>
            </section>
