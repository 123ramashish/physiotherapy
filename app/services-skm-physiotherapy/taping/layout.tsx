...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://www.skmphysiotherapy.com/services-skm-physiotherapy/taping",
    siteName: "SKM Physiotherapy & Rehabilitation Centre",
    images: [{ url: "https://www.skmphysiotherapy.com/og-taping.jpg", width: 1200, height: 630, alt: "Kinesiology Taping Therapy at SKM Physiotherapy Noida" }],
    locale: "en_IN", type: "website",
  },
  twitter: { card: "summary_large_image", title: "Kinesiology Taping | SKM Physiotherapy Noida", description: "K-Tape & sports taping for back pain, knee, shoulder & sports injuries in Noida.", images: ["https://www.skmphysiotherapy.com/og-taping.jpg"], creator: "@skmphysio" },
  alternates: { canonical: "https://www.skmphysiotherapy.com/services-skm-physiotherapy/taping" },
  ...
  "@graph": [
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 3, name: "Taping Therapy", item: "https://www.skmphysiotherapy.com/services-skm-physiotherapy/taping" },
      ],
    },
  ],
};
