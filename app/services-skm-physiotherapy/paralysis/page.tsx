...
import {
    Users, Heart, Activity, Clock, Shield, Award,
...
const PROCESS_STEPS: ProcessStep[] = [
    {
        number: 1,
        titleEn: 'Neuro Evaluation',
        titleHi: 'न्यूरो मूल्यांकन',
        descriptionEn: 'Detailed assessment of motor function, tone, and reflexes.',
        descriptionHi: 'मोटर फंक्शन, टोन और रिफ्लेक्सिस का विस्तृत मूल्यांकन।',
    ...
    },
    {
        ...
        titleHi: 'कार्यात्मक लक्ष्य',
        descriptionEn: 'Setting realistic milestones for sitting, standing, or walking.',
        descriptionHi: 'बैठने, खड़े होने या चलने के लिए वास्तविक मील के पत्थर निर्धारित करना।',
    ...
    {
        number: 3,
        titleEn: 'Neuro-Facilitation',
        titleHi: 'न्यूरो-सुविधा',
        descriptionEn: 'Advanced techniques (PNF, Bobath) to stimulate nerve pathways.',
        descriptionHi: 'तंत्रिका मार्गों को उत्तेजित करने के लिए उन्नत तकनीकें।',
    ...
    {
        number: 4,
        titleEn: 'Assistive Training',
        titleHi: 'सहायक प्रशिक्षण',
        descriptionEn: 'Training with walkers, canes, or orthotics if required.',
        descriptionHi: 'वॉकर, केन या ऑर्थोटिक्स के साथ प्रशिक्षण।',
        icon: <Shield className="w-6 h-6" />,
        duration: '30 mins',
        image: 'https://images.unsplash.com/photo-1581056344408-02600c2c5029?w=600&q=80'
    },
    {
        number: 5,
        titleEn: 'Caregiver Support',
        titleHi: 'देखभाल करने वाला समर्थन',
        descriptionEn: 'Training family members for safe home transfers.',
        descriptionHi: 'सुरक्षित होम ट्रांसफर के लिए परिवार के सदस्यों को प्रशिक्षण देना।',
...
const BENEFITS: Benefit[] = [
    {
        title: 'Regained Mobility',
        description: 'Systematic approach to restoring movement in affected limbs and improving walking ability.',
    ...
    },
    {
        ...
        description: 'Enhances the brain-muscle connection to improve balance and prevent falls.',
    ...
    {
        title: 'Muscle Tone Control',
        description: 'Specialized techniques to manage spasticity (stiffness) or flaccidity (weakness) in muscles.',
    ...
    },
    {
        ...
        description: 'Focused training on activities of daily living (ADLs) like dressing, eating, and grooming.',
    ...
    {
        title: 'Prevention of Contractures',
        description: 'Regular mobilization prevents permanent joint stiffness and secondary complications.',
    ...
    },
    {
        ...
        description: 'Empowers patients and families with the tools and confidence to live a more fulfilling life.',
...
const TESTIMONIALS: Testimonial[] = [
    {
        ...
        feedback: "When I came to SKM, I couldn't even sit without support. After 4 months of intensive neuro-rehab, I am now walking with a stick. The therapists are like family to me.",
        rating: 5,
        image: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&q=80',
        sessionCount: 48,
        improvement: 'Walking with assistance'
    },
    {
        id: 2,
        name: 'Rajiv Mehra',
        ...
        feedback: 'The level of expertise here in neuro-physiotherapy is unmatched. Their systematic approach helped me regain core strength and bladder control.',
        rating: 5,
        image: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=400&q=80',
        sessionCount: 60,
        improvement: 'Significant functional gain'
    }
];
...
const BEFORE_AFTER: BeforeAfter[] = [
    {
        id: 1,
        beforeImage: 'https://images.unsplash.com/photo-1571019614242-c5c5dee9f50b?w=600&q=80',
        afterImage: 'https://images.unsplash.com/photo-1581056344408-02600c2c5029?w=600&q=80',
        condition: 'Post-Stroke Gait',
        sessions: 36,
        improvement: 'Independent walking',
        videoUrl: 'https://www.w3schools.com/html/mov_bbb.mp4'
    }
];

const STATS = [
    { number: '850+', label: 'Stroke Survivors', icon: <Users className="w-6 h-6" /> },
    { number: '15,000+', label: 'Rehab Sessions', icon: <Activity className="w-6 h-6" /> },
    { number: '88%', label: 'Mobility Rate', icon: <Award className="w-6 h-6" /> },
    { number: '4.9★', label: 'Care Rating', icon: <Star className="w-6 h-6" /> }
];

const CONDITIONS = [
    { en: 'Stroke (Hemiplegia)', hi: 'लकवा (पक्षाघात)' },
    { en: 'Spinal Cord Injury', hi: 'रीढ़ की हड्डी में चोट' },
    { en: 'Parkinson\'s Disease', hi: 'पार्किंसंस रोग' },
    { en: 'Multiple Sclerosis', hi: 'मल्टीपल स्क्लेरोसिस' },
    { en: 'Cerebral Palsy', hi: 'सेरेब्रल पाल्सी' },
    { en: 'Traumatic Brain Injury', hi: 'मस्तिष्क की चोट' },
    { en: 'Guillain-Barré Syndrome', hi: 'जीबीएस सिंड्रोम' },
    { en: 'Neuropathy', hi: 'न्यूरोपैथी' }
];
        ...
        <div className="min-h-screen bg-gradient-to-b from-blue-50/50 to-white">
            ...
            <nav className="bg-white border-b border-blue-100 py-3">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex items-center gap-2 text-sm flex-wrap">
                        {[{ label: 'Home', href: '/' }, { label: 'Services', href: '/services-skm-physiotherapy' }, { label: 'Paralysis Rehab', href: null }]
            ...
            <section className="relative pt-12 pb-16 sm:pt-16 sm:pb-20 overflow-hidden min-h-[520px] sm:min-h-[600px]">
                <div className="absolute inset-0">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-r from-blue-900/85 via-blue-900/70 to-emerald-900/75" />
                </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-12 items-center">
                        <motion.div initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.6 }}>
                            <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/20 text-white rounded-full text-xs sm:text-sm font-medium mb-5 border border-white/30">
                                <Users className="w-4 h-4" /> Comprehensive Neuro-Rehabilitation
                            </div>
                            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-5 leading-tight">
                                Paralysis & Stroke Rehab
                                <span className="text-blue-200 block mt-2">Reclaim Your Independence</span>
                            </h1>
                            <p className="text-base sm:text-lg text-blue-100 mb-7 leading-relaxed">
                                Expert specialized care to restore motor function, improve balance, and rebuild strength. 
                                Our neuro-rehabilitation programs are evidence-based and personalized for every patient.
                            </p>

                            <div className="flex flex-wrap items-center gap-4 sm:gap-6 text-xs sm:text-sm text-blue-100">
                                <div className="flex items-center gap-2"><CheckCircle className="w-4 h-4 sm:w-5 sm:h-5 text-emerald-400" /><span>Neuro-Facilitation Specialists</span></div>
                                <div className="flex items-center gap-2"><CheckCircle className="w-4 h-4 sm:w-5 sm:h-5 text-emerald-400" /><span>Goal-Oriented Therapy</span></div>
                            </div>
                        </motion.div>
                        ...
                        <motion.div initial={{ opacity: 0, x: 30 }} animate={{ opacity: 1, x: 0 }}
                            ...
                            <div className="bg-white/95 backdrop-blur rounded-2xl p-6 shadow-2xl">
                                <div className="flex items-center gap-4 mb-4">
                                    <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-blue-500 to-emerald-600 flex items-center justify-center text-white shadow-lg">
                                        <Users className="w-7 h-7" />
                                    </div>
                                    <div>
                                        <p className="text-2xl sm:text-3xl font-bold text-gray-900">850+</p>
                                        <p className="text-sm text-gray-500">Stroke Survivors Treated</p>
                                    </div>
                                </div>
                                <div className="grid grid-cols-3 gap-4 pt-4 border-t border-gray-100">
                                    <div className="text-center"><p className="text-lg sm:text-xl font-bold text-blue-600">88%</p><p className="text-xs text-gray-500">Mobility</p></div>
                                    <div className="text-center"><p className="text-lg sm:text-xl font-bold text-blue-600">15k+</p><p className="text-xs text-gray-500">Sessions</p></div>
            ...
            {/* Stats Bar */}
            <section className="py-10 sm:py-12 bg-gradient-to-r from-blue-600 to-emerald-700">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-12 items-center">
                        <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
                            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-5">Neuro-Rehabilitation Approach</h2>
                            <div className="space-y-4 text-gray-600 leading-relaxed text-sm sm:text-base">
                                <p><strong className="text-gray-900">Paralysis Rehabilitation</strong> is a long-term journey of retraining the brain and nervous system. At SKM Physiotherapy, we use "Neuro-Plasticity" principles to help your brain find new pathways to control movement.</p>
                                <p>Our therapists are trained in <strong className="text-gray-900">Bobath and PNF techniques</strong>, which are globally recognized standards for stroke and spinal cord injury rehabilitation.</p>
                                <p>We don't just treat the patient; we empower the family with training and home modifications to ensure a safe and supportive environment for recovery.</p>
                            </div>
                            <div className="mt-7 space-y-2.5">
                                {['Neuro-Developmental Treatment (NDT)', 'Proprioceptive Neuromuscular Facilitation', 'Balance & Gait Retraining', 'Activities of Daily Living (ADL) Training'].map((item, index) => (
                        ...
                        <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="grid grid-cols-2 gap-4">
                            <img src="https://images.unsplash.com/photo-1571019614242-c5c5dee9f50b?w=400&q=80" alt="Neuro rehab"
                                className="rounded-2xl shadow-lg w-full h-48 sm:h-64 object-cover" />
                            <img src="https://images.unsplash.com/photo-1581056344408-02600c2c5029?w=400&q=80" alt="Patient support"
            ...
            <section className="py-14 sm:py-16 bg-gradient-to-b from-gray-50 to-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
                        ...
                        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-3">Benefits of Intensive Neuro Rehab</h2>
                        <p className="text-gray-600 text-base sm:text-lg">Structured recovery for better mobility and independent living</p>
                    </motion.div>
            ...
            <section className="py-14 sm:py-16 bg-gradient-to-b from-white to-blue-50/30">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
                        className="text-center max-w-3xl mx-auto mb-10 sm:mb-12">
                        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-3">Real Results: Recovery Journeys</h2>
                        <p className="text-gray-600 text-base sm:text-lg">Witness the incredible progress of our neuro-rehab patients</p>
                    </motion.div>
            ...
            <section className="py-14 sm:py-16 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
                        className="text-center max-w-3xl mx-auto mb-10 sm:mb-12">
                        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-3">The Path to Recovery</h2>
                        <p className="text-gray-600 text-base sm:text-lg">Step-by-step neuro-rehabilitation process</p>
                    </motion.div>
            ...
            <section className="py-14 sm:py-16 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
                        className="text-center max-w-3xl mx-auto mb-10 sm:mb-12">
                        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-3">Rehab Success Stories</h2>
                        <p className="text-gray-600 text-base sm:text-lg">Real progress from our neuro-physiotherapy patients</p>
                    </motion.div>
                    <div className="relative">
                    ...
                    <div className="justify-center gap-2 mt-6 hidden sm:flex">
            ...
            <section className="py-14 sm:py-16 bg-gradient-to-b from-emerald-50/30 to-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
                        className="text-center max-w-3xl mx-auto mb-10 sm:mb-12">
                        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-3">Neurological Conditions Treated</h2>
                        <p className="text-gray-500 text-sm sm:text-base">हम जो स्थितियां Treat करते हैं</p>
                        <p className="text-gray-600 text-base sm:text-lg mt-2">Expert neuro-rehabilitation for a range of conditions</p>
                    </motion.div>
            ...
            <section className="py-14 sm:py-16 bg-white">
                <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="space-y-3 sm:space-y-4">
                        {[
                            { q: 'When should neuro-rehabilitation start after a stroke?', a: 'Ideally, rehabilitation should start as soon as the patient is medically stable, often within 24 to 48 hours. Early intervention takes advantage of the brain\'s "neuroplasticity" window for the best results.' },
                            { q: 'How many sessions per week are needed for paralysis rehab?', a: 'For neuro-cases, consistency is key. We typically recommend 5 to 6 sessions per week in the initial intensive phase, which can be tapered as the patient gains independence.' },
                            { q: 'Do you provide home-based neuro-physiotherapy?', a: 'Yes, we provide specialized home visits for patients who have mobility challenges or are in the early stages of recovery post-discharge from the hospital.' },
                            { q: 'Can a person fully recover from paralysis?', a: 'Recovery depends on the severity and location of the nerve damage. While "full" recovery isn\'t always possible, significant functional gains and independence are achievable with dedicated long-term therapy.' },
                            { q: 'What advanced techniques do you use?', a: 'We use a combination of PNF (Proprioceptive Neuromuscular Facilitation), NDT (Bobath Approach), Task-Oriented Training, and clinical-grade Electrical Stimulation.' }
