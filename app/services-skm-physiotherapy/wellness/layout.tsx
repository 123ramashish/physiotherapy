...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://www.skmphysiotherapy.com/services-skm-physiotherapy/wellness",
    siteName: "SKM Physiotherapy & Rehabilitation Centre",
    images: [{ url: "https://www.skmphysiotherapy.com/og-wellness.jpg", width: 1200, height: 630, alt: "Wellness Physiotherapy at SKM Physiotherapy Noida" }],
    locale: "en_IN", type: "website",
  },
  twitter: { card: "summary_large_image", title: "Wellness Physiotherapy | SKM Noida", description: "Posture analysis, injury prevention & ergonomics coaching across Noida, Greater Noida & Gurugram.", images: ["https://www.skmphysiotherapy.com/og-wellness.jpg"], creator: "@skmphysio" },
  alternates: { canonical: "https://www.skmphysiotherapy.com/services-skm-physiotherapy/wellness" },
  ...
  "@graph": [
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 3, name: "Wellness Physiotherapy", item: "https://www.skmphysiotherapy.com/services-skm-physiotherapy/wellness" },
      ],
    },
  ],
};
