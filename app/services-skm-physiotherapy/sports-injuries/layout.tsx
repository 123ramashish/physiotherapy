...
export const metadata: Metadata = {
  title: "Sports Injury Rehabilitation in Noida & Greater Noida | SKM Physiotherapy",
  description:
    "Expert sports injury physiotherapy at SKM in Noida & Greater Noida. Treatment for ACL tears, muscle strains, ligament sprains, tennis elbow, ankle sprains & post-surgery sports rehab. Certified sports physiotherapists. Get back to peak performance.",
  keywords: [
  ...
  openGraph: {
    ...
    description: "Get back to peak performance. Expert sports physio for ACL, muscle tears, sprains, tennis elbow & more in Noida & Greater Noida.",
