...
export const metadata: Metadata = {
  ...
  description:
    "Therapeutic relaxation physiotherapy at SKM across Noida, Greater Noida & Gurugram. Stress relief massages, myofascial release, breathing therapy & relaxation techniques for stress-related muscle tension, burnout and chronic fatigue. Book a session today.",
  keywords: [
