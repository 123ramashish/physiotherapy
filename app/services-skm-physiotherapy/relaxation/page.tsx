...
import {
    Heart, Activity, Clock, Shield, Award,
...
const PROCESS_STEPS: ProcessStep[] = [
    {
        number: 1,
        titleEn: 'Stress Assessment',
        titleHi: 'तनाव मूल्यांकन',
        descriptionEn: 'Identifying areas of high muscle tension and postural fatigue.',
        descriptionHi: 'उच्च मांसपेशियों के तनाव और शारीरिक थकान के क्षेत्रों की पहचान करना।',
    ...
    {
        number: 2,
        titleEn: 'Soft Tissue Release',
        titleHi: 'सॉफ्ट टिश्यू रिलीज',
        descriptionEn: 'Deep rhythmic manual therapy to release surface muscle knots.',
        descriptionHi: 'सतह की मांसपेशियों की गांठों को ढीला करने के लिए मैन्युअल थेरेपी।',
    ...
    {
        number: 3,
        titleEn: 'Myofascial Stretching',
        titleHi: 'मायोफेशियल स्ट्रेचिंग',
        descriptionEn: 'Slow, sustained stretches to restore tissue elasticity.',
        descriptionHi: 'ऊतकों की लोच बहाल करने के लिए धीमी और निरंतर स्ट्रेचिंग।',
    ...
    {
        number: 4,
        titleEn: 'Relaxation Modalities',
        titleHi: 'विश्राम तकनीकें',
        descriptionEn: 'Therapeutic heat and gentle vibrational therapy for deep rest.',
        descriptionHi: 'गहरे आराम के लिए चिकित्सीय गर्मी और कोमल कंपन चिकित्सा।',
    ...
    {
        number: 5,
        titleEn: 'Wellness Coaching',
        titleHi: 'कल्याण कोचिंग',
        descriptionEn: 'Guidance on ergonomic habits and home relaxation routines.',
        descriptionHi: 'एर्गोनोमिक आदतों और घर पर विश्राम की दिनचर्या पर मार्गदर्शन।',
...
const BENEFITS: Benefit[] = [
    {
        title: 'Instant De-Stressing',
        description: 'Lowers cortisol levels and promotes a profound sense of mental and physical calm.',
    ...
    {
        title: 'Ends Muscle Fatigue',
        description: 'Flushes out lactic acid and metabolic waste to resolve post-workout or desk-job soreness.',
    ...
    },
    {
        ...
        description: 'Prepares your nervous system for deeper, uninterrupted sleep cycles through physical relaxation.',
    ...
    },
    {
        ...
        description: 'Improves blood and lymph flow to all major muscle groups for overall vitality.',
    ...
    {
        title: 'Posture Integrity',
        description: 'Releasing tight chest and neck muscles helps you stand taller and move with more ease.',
    ...
    },
    {
        ...
        description: 'Regular clinical relaxation supports the body\'s natural defense mechanisms by reducing physiological stress.',
...
const TESTIMONIALS: Testimonial[] = [
    {
        ...
        name: 'Sanjeev Kumar',
        age: 41,
        condition: 'Corporate Stress & Soreness',
        feedback: 'The weekly relaxation sessions at SKM are my "reset" button. The myofascial release combined with heat therapy is incredible for my desk-job neck pain.',
        rating: 5,
        image: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&q=80',
        sessionCount: 12,
        improvement: 'Zero desk-job pain'
    }
];
...
const BEFORE_AFTER: BeforeAfter[] = [
    {
        ...
        condition: 'Muscle Guarding (Shoulders)',
        sessions: 3,
        improvement: 'Natural shoulder alignment',
        videoUrl: 'https://www.w3schools.com/html/mov_bbb.mp4'
    }
];

const STATS = [
    { number: '1,500+', label: 'Relaxed Patients', icon: <Heart className="w-6 h-6" /> },
    { number: '5,000+', label: 'Wellness Sessions', icon: <Activity className="w-6 h-6" /> },
    { number: '99%', label: 'Stress Reduction', icon: <Award className="w-6 h-6" /> },
    { number: '4.9★', label: 'Patient Rating', icon: <Star className="w-6 h-6" /> }
];

const CONDITIONS = [
    { en: 'Muscle Soreness', hi: 'मांसपेशियों में दर्द' },
    { en: 'Chronic Fatigue', hi: 'पुरानी थकान' },
    { en: 'Mental Stress', hi: 'मानसिक तनाव' },
    { en: 'Post-Workout Aches', hi: 'वर्कआउट के बाद का दर्द' },
    { en: 'Insomnia', hi: 'अनिद्रा' },
    { en: 'Corporate Burnout', hi: 'कॉर्पोरेट बर्नआउट' }
];
        ...
        <div className="min-h-screen bg-gradient-to-b from-blue-50/50 to-white">
            ...
            <nav className="bg-white border-b border-blue-100 py-3">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex items-center gap-2 text-sm flex-wrap">
                        {[{ label: 'Home', href: '/' }, { label: 'Services', href: '/services-skm-physiotherapy' }, { label: 'Soreness & Relaxation', href: null }]
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-12 items-center">
                        <motion.div initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.6 }}>
                            <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/20 text-white rounded-full text-xs sm:text-sm font-medium mb-5 border border-white/30">
                                <Heart className="w-4 h-4" /> Professional Clinical Relaxation
                            </div>
                            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-5 leading-tight">
                                Soreness & Relaxation
                                <span className="text-blue-200 block mt-2">Recharge Your Body & Mind</span>
                            </h1>
                            <p className="text-base sm:text-lg text-blue-100 mb-7 leading-relaxed">
                                Therapeutic relaxation techniques, soft tissue therapy, and clinical recovery protocols to ease muscle soreness and chronic stress. Experience a deeper level of rest.
                            </p>

                            <div className="flex flex-wrap items-center gap-4 sm:gap-6 text-xs sm:text-sm text-blue-100">
                                <div className="flex items-center gap-2"><CheckCircle className="w-4 h-4 sm:w-5 sm:h-5 text-emerald-400" /><span>Deep Tissue Specialists</span></div>
                                <div className="flex items-center gap-2"><CheckCircle className="w-4 h-4 sm:w-5 sm:h-5 text-emerald-400" /><span>Stress Management</span></div>
                            </div>
                        </motion.div>
                        ...
                        <motion.div initial={{ opacity: 0, x: 30 }} animate={{ opacity: 1, x: 0 }}
                            ...
                            <div className="bg-white/95 backdrop-blur rounded-2xl p-6 shadow-2xl">
                                <div className="flex items-center gap-4 mb-4">
                                    ...
                                    <div>
                                        <p className="text-2xl sm:text-3xl font-bold text-gray-900">1,500+</p>
                                        <p className="text-sm text-gray-500">Wellness Clients Served</p>
                                    </div>
                                </div>
                                <div className="grid grid-cols-3 gap-4 pt-4 border-t border-gray-100">
                                    <div className="text-center"><p className="text-lg sm:text-xl font-bold text-blue-600">99%</p><p className="text-xs text-gray-500">Relief</p></div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-12 items-center">
                        <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
                            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-5">Clinical Wellness for Modern Life</h2>
                            <div className="space-y-4 text-gray-600 leading-relaxed text-sm sm:text-base">
                                <p><strong className="text-gray-900">Relaxation Therapy</strong> at SKM is more than just a spa day. It is a medically grounded approach to resolving systemic physical stress. We target the "autonomic nervous system" to shift your body from "Fight-or-Flight" mode into its natural healing state.</p>
                                <p>Our program combines <strong className="text-gray-900">Soft Tissue Manipulation</strong> with clinical modalities to release muscle guarding and improve systemic circulation. This is ideal for those suffering from corporate burnout, athletic fatigue, or chronic tension.</p>
                                <p>We don't just treat the symptoms; we coach you on breathing and ergonomic habits to ensure you maintain your sense of calm long after leaving our clinic.</p>
                            </div>
                            <div className="mt-7 space-y-2.5">
                                {['Deep Tissue Myofascial Release', 'Clinical Heat & Vibration Therapy', 'Autonomic Nervous System Regulation', 'Ergonomic Habit & Sleep Coaching'].map((item, index) => (
                        ...
                        <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="grid grid-cols-2 gap-4">
                            <img src="https://images.unsplash.com/photo-1544161515-4ab6ce6db874?w=400&q=80" alt="Relaxation therapy"
                                className="rounded-2xl shadow-lg w-full h-48 sm:h-64 object-cover" />
                            <img src="https://images.unsplash.com/photo-1519494026892-80bbd2d6fd0d?w=400&q=80" alt="Stress relief"
            ...
            <section className="py-14 sm:py-16 bg-gradient-to-b from-gray-50 to-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
                        ...
                        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-3">The Benefits of Deep Rest</h2>
                        <p className="text-gray-600 text-base sm:text-lg">Specialized benefits for physical recovery and mental wellbeing</p>
                    </motion.div>
            ...
            <section className="py-14 sm:py-16 bg-gradient-to-b from-white to-blue-50/30">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
                        className="text-center max-w-3xl mx-auto mb-10 sm:mb-12">
                        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-3">Visible Transformation</h2>
                        <p className="text-gray-600 text-base sm:text-lg">See how clinical relaxation corrects tension and posture</p>
                    </motion.div>
            ...
            <section className="py-14 sm:py-16 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
                        className="text-center max-w-3xl mx-auto mb-10 sm:mb-12">
                        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-3">Our Systematic Wellness Process</h2>
                        <p className="text-gray-600 text-base sm:text-lg">A clinical journey from stress to serenity</p>
                    </motion.div>
            ...
            <section className="py-14 sm:py-16 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
                        className="text-center max-w-3xl mx-auto mb-10 sm:mb-12">
                        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-3">Wellness Success Stories</h2>
                        <p className="text-gray-600 text-base sm:text-lg">Hear from clients who found their balance at SKM</p>
                    </motion.div>
                    <div className="relative">
            ...
            <section className="py-14 sm:py-16 bg-gradient-to-b from-blue-50/30 to-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
                        className="text-center max-w-3xl mx-auto mb-10 sm:mb-12">
                        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-3">Wellness Challenges We Solve</h2>
                        <p className="text-gray-500 text-sm sm:text-base">हम जो स्थितियां Treat करते हैं</p>
                        <p className="text-gray-600 text-base sm:text-lg mt-2">Clinical relaxation is effective for various stress and fatigue related issues</p>
                    </motion.div>
            ...
            <section className="py-14 sm:py-16 bg-white">
                <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="space-y-3 sm:space-y-4">
                        {[
                            { q: 'Is this just a massage?', a: 'No. Clinical relaxation at SKM is performed by trained physiotherapists who understand anatomy and nerve pathways. We use specific techniques to release myofascial restrictions and regulate your nervous system.' },
                            { q: 'How often should I come for wellness sessions?', a: 'For chronic stress or high-performance lifestyles, we recommend a maintenance session every 1-2 weeks. For acute soreness, 2-3 sessions in a single week can provide significant relief.' },
                            { q: 'Can this help with my sleep issues?', a: 'Yes. By reducing physiological arousal and muscle guarding, our relaxation protocols help transition your body into the parasympathetic state needed for restful sleep.' },
                            { q: 'What is Myofascial Release?', a: 'It is a specialized manual therapy technique that involves applying gentle, sustained pressure into the connective tissue restrictions to eliminate pain and restore motion.' },
                            { q: 'Do you provide corporate wellness packages?', a: 'Yes, we provide specialized on-site and in-clinic wellness programs for corporate teams to manage desk-job fatigue and employee burnout.' }
            ...
            <section className="py-16 bg-gradient-to-r from-blue-600 to-indigo-700 text-white">
                <div className="max-w-4xl mx-auto px-4 text-center">
                    <h2 className="text-3xl sm:text-4xl font-bold mb-4 text-white">Recharge Your Vitality</h2>
                    <p className="text-blue-50 mb-8 text-lg opacity-90">Don't wait for burnout. Book your clinical relaxation session today and feel the difference in your body and mind.</p>
